package com.sida.xiruo.xframework.cache.redis.jpush;
...
public class JpushClientUtil {
     ...
     * @return 0推送失败，1推送成功
     */
    public int sendToRegistrationId( String registrationId,String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
        int result = 0;
        try {
    ...
    //extrasparam为携带特殊字段信息用于与前端交互，目前此字段只用于message部分。
    private PushPayload buildPushObject_android_and_ios(String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
        PushPayload pushPayload = PushPayload.newBuilder().build();
    ...
    private PushPayload buildPushObject_all_registrationId_alertWithTitle(String registrationId,String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
    ...
    private PushPayload buildPushObject_android_all_alertWithTitle(String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
    ...
    private PushPayload buildPushObject_ios_all_alertWithTitle( String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
