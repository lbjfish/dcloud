...
public class SysInfoChangeLog extends BaseEntity implements Serializable {
    ...
    @ApiModelProperty("信息类型：片区用户及角色（AREA、USER、ROLE）")
    ...
    public void setInfoColumn(String infoColumn) {
        this.infoColumn = infoColumn == null ? null : infoColumn.trim();
    }
